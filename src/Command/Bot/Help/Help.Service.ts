import { MessageActionRow, MessageEmbed, MessageSelectMenu, Collector, ColorResolvable } from 'discord.js';
...
export default class HelpService
{
    ...
    async structure(Interaction: { reply?: any; followUp?: any; channel?: { createMessageComponentCollector: (arg0: { componentType: string; time: number }) => any }; id?: string }, Type?: string, Event?: any)
    {
    ...
    async menuCollector(Interaction: any)
    {
    ...
    async send(Interaction: { reply?: any; followUp?: any; channel?: { createMessageComponentCollector: (arg0: { componentType: string; time: number; }) => any; }; id?: string; })
    {
        try
        {
